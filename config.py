...
OWNER_USERNAME = getenv("OWNER_USERNAME", "Devil_Fan_Boy")
BOT_USERNAME = getenv("BOT_USERNAME", "NottyFanBoyBot")
BOT_NAME = getenv("BOT_NAME", "❍⏤͟͞●𝐍❍ʈʈ𝐘༎꯭ࠫ𓆩 ⃝⃪⃕𝐅𝙰ɳ𝗕๏‌𝕪❜𝆺꯭𝅥𝆺꯭𝅥༎ࠫ,")
ASSUSERNAME = getenv("ASSUSERNAME", "Devil_Fan_Boy")
EVALOP = list(map(int, getenv("EVALOP", "6507443481").split()))
MONGO_DB_URI = getenv("MONGO_DB_URI", None)
LOGGER_ID = int(getenv("LOGGER_ID", -1002133444856))
DURATION_LIMIT_MIN = int(getenv("DURATION_LIMIT", 17000))
# External APIs - Get these from their respective providers
GPT_API = getenv("GPT_API")
DEEP_API = getenv("DEEP_API")
OWNER_ID = int(getenv("OWNER_ID", 6507443481))

# Heroku deployment settings - Refer to Heroku documentation on how to obtain these
HEROKU_APP_NAME = getenv("HEROKU_APP_NAME")
HEROKU_API_KEY = getenv("HEROKU_API_KEY")
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/CuteDevilKing/DevilMusic-")
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "Master")
GIT_TOKEN = getenv("GIT_TOKEN", None)

# Support and contact information - Provide your own support channels
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/Devil_Baba_Chats")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/Devil_Baba_Chats")
...
START_IMG_URL = getenv(
    "START_IMG_URL", "https://telegra.ph/file/6d39fad4925de55b86e96.jpg"
)
PING_VID_URL = getenv(
...
TELEGRAM_AUDIO_URL = "https://telegra.ph/file/6d39fad4925de55b86e96.jpg"
TELEGRAM_VIDEO_URL = "https://telegra.ph/file/c8db17e1612487be13571.jpg"
STREAM_IMG_URL = "https://telegra.ph/file/6d39fad4925de55b86e96.jpg"
